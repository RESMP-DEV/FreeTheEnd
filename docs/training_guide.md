...
> **Note on Minecraft Version Accuracy:** The simulator's **physics** and **AI** are accurate to 
> **Minecraft 1.8.9**. This includes gravity, drag, knockback, projectiles, and all mob behavior 
> (Ender Dragon, Enderman, Blaze, Zombie, Skeleton). The Ender Dragon uses the 1.8.9 phase system 
> (circling, strafing, charging, dying)
