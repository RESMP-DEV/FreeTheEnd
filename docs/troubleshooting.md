...
find contrib/minecraft_sim -name "mc189_core*"

# Check library dependencies
otool -L contrib/minecraft_sim/python/minecraft_sim/mc189_core*.so  # macOS
ldd contrib/minecraft_sim/python/minecraft_sim/mc189_core*.so       # Linux
...
file contrib/minecraft_sim/python/minecraft_sim/mc189_core*.so
